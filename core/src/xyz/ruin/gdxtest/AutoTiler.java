...
public class AutoTiler {
    ...
    public InstancedMap generateInstancedMap() {
        TiledMap map = generateMap();
        return new InstancedMap(mapWidth, mapHeight, map, tileSet, tileWidth, tileHeight);
    }
     ...
     */
    private void init(TilesetConfig conf) {
